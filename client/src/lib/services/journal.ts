...
export class JournalService {
  ...
  static async createEntry(entry: CreateJournalEntry): Promise<JournalEntry> {
    try {
      ...
      // Debug: Log enhanced sentiment analysis results
      if (enhancedSentiment.insights.length === 0) {
        console.warn('WARNING: No insights generated by enhanced sentiment analysis');
