...
export interface AIAnalysisResult {
  ...
  insights?: string[];  // Business coach insights generated by AI
  emotions?: string[];  // Detected emotions from analysis
  suggested_title?: string;  // AI-generated title suggestion
  analysis_method?: string;  // Source of analysis (e.g., 'hugging-face-ai')
  ai_heading?: string;  // AI-generated heading from enhanced analysis
  analysis_source?: string;  // Source identifier (e.g., 'hugging-face-server', 'fallback-system')
  rules_matched?: string[];  // Rules that matched in analysis
  user_learned?: boolean;  // Whether the user learned something new
